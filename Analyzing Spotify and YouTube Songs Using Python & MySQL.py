...
def Handle_Null_values():
    ...
    #df = df.fillna(value={col: 0 if df[col].dtype == int else 'NA' for col in df.columns})
...
...     df=change_the_datatype()
    ...
    #WRITE YOUR CODE HERE
    df['most_playedon']=df.apply(lambda row: 'Youtube' if row['Views']>row['Stream'] else 'Spotify', axis=1)
    #return dataframe
    return df
...
def export_the_cleaned_dataset():
    ...
    #WRITE YOUR CODE HERE
    #filepath = os.path.join('C:\Users\admin12\Desktop', 'cleaned_dataset.csv')
